...
public abstract class AbstractInvoiceTransformer<T> {
    ...
    @Autowired
    protected ZatcaHeaderErpRepository zatcaHeaderErpRepository;


    public abstract List<T> transform(List<ZatcaHeaderERP> invoices);
    ...
    protected void reformatObjectData(ZatcaHeaderERP inv) {
        try {
